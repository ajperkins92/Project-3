        ...
        <nav>
            <div className="nav-wrapper indigo">
                ...
                <ul id="nav-mobile" className="right hide-on-med-and-down">
                    ...
                    <li className={(props.loggedIn === "true") ? "" : "hidden"}><Link to="/signup">{`Welcome, ${localStorage.getItem('username')}!`}</Link></li>
                    <li onClick={props.manageLogin}><Link to={(props.loggedIn === "true") ? "/" : "/loginpage"}>{(props.loggedIn === "true") ? "Log Out" : "Log In"}</Link></li>
